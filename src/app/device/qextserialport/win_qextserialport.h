...
class Win_QextSerialPort: public QextSerialBase 
{
	...
	public:
        ...
        bool doRecTemperature(char cHead,char *cAddress,int iType);
        bool doRecHumidity(char cHead,char *cAddress,int iType);
        bool doRecIlluminance(char cHead,char *cAddress);
        bool doRecReturn(char cHead,char *cAddress,char *cCommand);
        bool doRecReturnSS(char cHead,char *cAddress,char *cCommand);
        bool doRecReturnX(char cHead,char *cAddress,char *cCommand,int iTure);
        bool doRecReturnNULL(void);
        int doRecReturnGIN(void);
        int doRecReturnVIN(void);
        bool doRecReturn851(char cHead,char *cAddress,int val03,int val04,int val05);
        bool doRecReturn852(char cHead,char *cAddress,int val03,int val04,int val05);
        virtual qint64 sizeSukon() const;
	    /*!
